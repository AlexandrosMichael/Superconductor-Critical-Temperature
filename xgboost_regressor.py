...
# method which carries out the cross validation and grid search process for the xgboost model using the training set
...
# method used to carry out the xgboost model selection process
...
# method used to carry out the xgboost model selection process and also the evaluation process on the test set
